package com.itm.springboot.controller;


import com.itm.springboot.model.User;
import com.itm.springboot.service.UserService;
...
public class UsersController {
    ...
    @GetMapping("/{id}/edit")
    public String editUserForm(@PathVariable("id") long id, Model model, RedirectAttributes attributes) {
        User user = userService.readUser(id);
        if (user == null) {
            attributes.addFlashAttribute("flashMessage", "User does not exist!");
    ...
    public String deleteUser(@RequestParam("id") long id, RedirectAttributes attributes) {
        ...
        attributes.addFlashAttribute("flashMessage", (user == null) ? "User does not exist!" :
